...
void encrypt(uchar8_t p[4][4], uchar8_t k[32], uchar8_t c[4][4])
{
...
void decrypt(uchar8_t c[4][4], uchar8_t k[32], uchar8_t p[4][4])
{
	uchar8_t roundKey[15][4][4];
	generateKeys(k, roundKey);
...
int main()
{
    printf("*******************This an implementation of AES-256 ********************\n");
    ...
    else if(choice == 2)
    {
        ...
        uchar8_t K[32] = {0x62, 0x8c, 0xfd, 0xb2, 0x8e, 0x6e, 0x31, 0x8d, 0x35, 0x83, 0xd6, 0x25, 0x3f, 0xc4, 0xd4, 0x4a, 0x0f, 0x15, 0x71, 0xc9, 0x47, 0xd9, 0xe8, 0x59, 0x0c, 0xb7, 0xad, 0xd6, 0xaf, 0x7f, 0x67, 0x98};
    ...
    else if(choice == 3)
    {
        ...
        uchar8_t K[32] =  {0x62, 0x8c, 0xfd, 0xb2, 0x8e, 0x6e, 0x31, 0x8d, 0x35, 0x83, 0xd6, 0x25, 0x3f, 0xc4, 0xd4, 0x4a, 0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10};
    ...
    else if(choice == 4)
    {
        ...
        uchar8_t K[32] = {0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10, 0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10};
